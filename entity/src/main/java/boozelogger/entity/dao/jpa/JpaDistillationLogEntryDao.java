 ...
 * Time: 1:35 PM
 */
public class JpaDistillationLogEntryDao extends JpaDataAccessObject<Integer,DistillationLogEntry> implements IDistillationLogEntryDao {
    @Log
     ...
     */
    @Inject
    public JpaDistillationLogEntryDao(Provider<EntityManager> entityManagerProvider) {
        super(entityManagerProvider);
    }

    @Override
    public List<DistillationLogEntry> loadByParameters(Map map) throws EntityNotFoundException, DaoException {
        return loadAll();
    }
}
