 ...
 * Time: 1:35 PM
 */
public class JpaFermentLogDao extends JpaDataAccessObject<Integer,FermentLog> implements IFermentLogDao {
    @Log
     ...
     */
    @Inject
    public JpaFermentLogDao(Provider<EntityManager> entityManagerProvider) {
        super(entityManagerProvider);
    }

    @Override
    public List<FermentLog> loadByParameters(Map map) throws EntityNotFoundException, DaoException {
        return loadAll();
    }
}
