 ...
 * Time: 1:09 PM
 */
public interface IIngredientDao extends DataAccessObject<Integer, Ingredient> {

    List<Ingredient> loadByParameters(Map map) throws EntityNotFoundException, DaoException;
