 ...
 * Time: 1:09 PM
 */
public interface IProcessDao extends DataAccessObject<Integer, Process> {

    List<Process> loadByParameters(Map map) throws EntityNotFoundException, DaoException;
