	...
	<body>
		...
		<div id="show-recipe" class="content scaffold-show" role="main">
			...
			<ol class="property-list recipe">
				...
				<g:if test="${recipeInstance?.createdAt}">
				<li class="fieldcontain">
					<span id="createdAt-label" class="property-label"><g:message code="recipe.createdAt.label" default="Created At" /></span>
					
						<span class="property-value" aria-labelledby="createdAt-label"><g:formatDate date="${recipeInstance?.createdAt}" /></span>
